...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-dom`;
  ...
  // vue-script:/Users/yishuai/develop/arch/esbuild-learn/plugins/plutin-use/hello.vue?type=script
  var _hoisted_1 = { class: "container" };
  var hello_default = /* @__PURE__ */ defineComponent({
    __name: "hello",
    setup(__props) {
      const count = ref(0);
      const handleAdd = () => {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", null, [
          createBaseVNode("div", _hoisted_1, "current count: " + toDisplayString(count.value), 1),
  ...
  // plugins/plutin-use/hello.vue
  var hello_default2 = hello_default;
  hello_default.__scopeId = "data-v-6ccb2d2c";

  // plugins/plutin-use/index.ts
  var root = document.createElement("div");
  var app = createApp(hello_default2);
  app.mount(root);
  nextTick(() => {
